...
public class WMProxyIntParametricTemplateTest {
	...
	*/
	public static void runTest ( String url, String proxyFile, String configFile ) throws java.lang.Exception {
		...
		WMProxyStub.StringList attributeList = null ;
		int paramNumber = 0;
...
System.out.println ("--------------------------------------------------------------------------------------------------------------------------------");
		...
		result = client.getIntParametricJobTemplate(attributeList.getItem(), paramNumber, parameterStart, parameterStep, requirements, rank);
		// result
