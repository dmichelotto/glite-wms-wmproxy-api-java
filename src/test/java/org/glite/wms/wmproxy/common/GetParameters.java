...
import org.glite.wms.wmproxy.ws.WMProxyStub.JobType;
import org.glite.wms.wmproxy.ws.WMProxyStub.JobTypeList;
import org.glite.wms.wmproxy.ws.WMProxyStub.StringList;
...
public class GetParameters {
	...
	*/
	public GetParameters (String file ) throws  java.io.IOException{
		...
		this.typeTable = new Hashtable<String, JobType> ( );
		this.typeTable.put (GetParameters._NORMAL, JobType.NORMAL);
		this.typeTable.put (GetParameters._PARAMETRIC, JobType.PARAMETRIC);
		this.typeTable.put (GetParameters._INTERACTIVE, JobType.INTERACTIVE);
		this.typeTable.put (GetParameters._MPI,  JobType.MPI);
		this.typeTable.put (GetParameters._PARTITIONABLE, JobType.PARTITIONABLE);
		this.typeTable.put (GetParameters._CHECKPOINTABLE,  JobType.CHECKPOINTABLE);
	...
	*/
	...
	// structures
	private Hashtable<String, JobType> typeTable = null ;
	...
	public JobTypeList getJobType ( ) throws java.lang.NoSuchFieldException, java.lang.IllegalArgumentException {
		...
		String format = GetParameters.JOBTYPE + GetParameters.SEPARATOR_TOKEN + START_LIST_TOKEN + "element 1 " + SEPARATOR_LIST_TOKEN +
					"element 2" + SEPARATOR_LIST_TOKEN + "...." + END_LIST_TOKEN ;
		// Acquires the JobType line from the configuration file
		line = this.getParameter ( GetParameters.JOBTYPE ) ;
		System.out.println ( "jobtype 	= [" + line + "]");
		// Splits up label and the list of values basing on the Separator Token
		tokens = new StringTokenizer(line, GetParameters.SEPARATOR_TOKEN);
		...
		label = label.trim( );
		if ( label.compareTo (GetParameters.JOBTYPE) != 0 )
		...
		tokens = new StringTokenizer(list, GetParameters.SEPARATOR_LIST_TOKEN );
	...
	public StringList getStringList (String parameter) throws java.lang.NoSuchFieldException, java.lang.IllegalArgumentException {
		...
		String format = parameter + GetParameters.SEPARATOR_TOKEN + START_LIST_TOKEN + "element 1 " + SEPARATOR_LIST_TOKEN +
					"element 2" + SEPARATOR_LIST_TOKEN + "...." + END_LIST_TOKEN ;
