...
import org.glite.wms.wmproxy.ws.WMProxyStub.JobIdStructType;
...
public class WMProxyJobRegisterTest {
	...
	*/
	public static void runTest ( String url, String proxyFile, String delegationId, String jdlFile, String certsPath   ) throws  BaseException, AuthenticationFaultException {
		//jdl
		String jdlString = "";
		// output results
