...
/**
 * This exception is thrown to indicate that an input argument of the requested
 * operation is not valid (i.e. the JobId string, the JDL expression, a single
 * JDL attribute expresion, etc..)
 */
