...
/**
 * This exception is thrown to indicate that an authentication error occurs
 * while accessing the WMProxy services. An authentication error can happen, for
 * example, when the user credentials is either invalid or expired.
 */
